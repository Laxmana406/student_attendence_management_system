...
def admin_attendance_view(request):
    ...
    # # recipient_list = [harshith]
    # send_mail('subject', 'message', 'ravikumarshetty896@gmail.com', ['harshith1996nov@gmail.com', ])
...
def admin_take_attendance_view(request,cl):
    ...
    if request.method=='POST':
        ...
        # email_from = settings.EMAIL_HOST_USER
        # # recipient_list = [harshith]
        # send_mail('subject', 'message', 'ravikumarshetty896@gmail.com', ['karnalax987@gmail.com', ])
...
# for aboutus and contact ussssssss
